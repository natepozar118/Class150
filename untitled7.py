...
friend_list["text"] = "Your friendlistlist : " + str(list1)
...
lucky_friend["text"] + "your luck friend is: " + str(generated_random_number)
...
lucky_friend.place(relx= 0.5,rely = 0.5, anchor = CENTER )
